...
public class SpriteData
{
	...
	public Texture texture {
		get {
			return _sprite.spriteContainer.texture;
		}
	}
	...
	public void UpdateUVs ()
	{
		if (texture != null) {
			...
			Vector2 yOffset = new Vector2 (0, _size.y / (float)texture.height);
	...
	{
		_sprite.transform.localScale = new Vector3 (_size.x, _size.y, 0);
	}
